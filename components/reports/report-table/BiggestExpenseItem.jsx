...
export function BiggestExpenseItem({ transactions }) {
    ...
    return (
      <Card className="p-6">
        ...
        <EmptyState
          icon={ArrowUpRight}
          title="No Expenses"
          description="No expense transactions found for this period."
          className="py-8"
        />
      </Card>
    );
        ...
        {transactions.map((transaction, index) => (
          ...
          >
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                {index === 0 ? (
                  ...
                  <span className="text-sm font-bold text-red-700 bg-red-200 px-2 py-1 rounded">
                    #{index + 1}
                  </span>
                )}
            ...
            <div className="text-right ml-4">
              ...
              <p className="text-xs text-gray-600">{transaction.wallet?.name}</p>
            </div>
          </div>
        ))}
      </div>
